package hernandez.brandon.myfeelings

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import android.widget.Toast
import hernandez.brandon.myfeelings.utilities.CustomBarDrawable
import hernandez.brandon.myfeelings.utilities.CustomCircleDrawable
import hernandez.brandon.myfeelings.utilities.Emociones
import hernandez.brandon.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria(){
        ...
        if(verysad>happy && verysad>neutral && verysad>sad && verysad>veryHappy){
            icon.setImageDrawable(resources.getDrawable(R.drawable.ic_very_disatisfied))
        }
    }
